...
The final interface makes several kinds of state visible without requiring the person to understand the scheduling engine: active relationships and inactive design hypotheses, automatic and pinned dates, fixed appointments, deadline conflicts, provisional requests, saved and previewed plans, and undo. The visual design was simplified until those distinctions carried the screen.
...
1. Do people understand automatic, pinned, and fixed dates, as well as inactive design hypotheses, without explanation?
